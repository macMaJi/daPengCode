 ...
 * @author zhy
 */
public class PositionViewPagerIndicator extends LinearLayout {
    /**
     * 绘制滑动横线的画笔
     */
     ...
     * 标题正常时的颜色
     */
    private static int COLOR_TEXT_NORMAL = 0xffadddff;
    /**
     * 标题选中时的颜色
     */
    ...
    public PositionViewPagerIndicator(Context context) {
        this(context, null);
    }

    public PositionViewPagerIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                COUNT_DEFAULT_TAB);
        COLOR_TEXT_NORMAL = a.getColor(R.styleable.MyViewPagerIndicator_unselect_text_color, 0xffadddff);
        COLOR_TEXT_HIGHLIGHTCOLOR = a.getColor(R.styleable.MyViewPagerIndicator_select_text_color, 0xffffffff);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mTriangleWidth = (int) (w / mTabVisibleCount / 4);//

        // 初始时的偏移量
        mInitTranslationX = (getWidth() / mTabVisibleCount - mTriangleWidth) / 2;
//        mInitTranslationX = getWidth() / mTabVisibleCount / 2 ;
     ...
     * 更新数量文本
     */
    public void resetTextView(int index, String str) {
        mTabTitles.set(index, str);
