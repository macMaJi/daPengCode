...
public class RecycleBinAdapterTemp extends BaseSectionQuickAdapter<MySection, BaseViewHolder> {

    private boolean isCheckboxShow = false;
    private boolean isLeftSwipeOut = true;
    private int checkboxNum = 0;

    public RecycleBinAdapterTemp(int layoutResId, int sectionHeadResId, List data) {
